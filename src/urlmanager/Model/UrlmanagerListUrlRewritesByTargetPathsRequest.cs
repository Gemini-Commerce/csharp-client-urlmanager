...
namespace urlmanager.Model
{
    ...
    /// </summary>
    [DataContract(Name = "urlmanagerListUrlRewritesByTargetPathsRequest")]
    public partial class UrlmanagerListUrlRewritesByTargetPathsRequest : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UrlmanagerListUrlRewritesByTargetPathsRequest" /> class.
        /// </summary>
        /// <param name="tenantId">Required..</param>
        /// <param name="targetPaths">Required..</param>
        /// <param name="context">Optional..</param>
        /// <param name="linkRel">linkRel.</param>
        public UrlmanagerListUrlRewritesByTargetPathsRequest(string tenantId = default(string), List<string> targetPaths = default(List<string>), string context = default(string), UrlRewriteLinkRel? linkRel = default(UrlRewriteLinkRel?))
        {
        ...
        /// </summary>
        /// <value>Required.</value>
        [DataMember(Name = "targetPaths", EmitDefaultValue = false)]
