...
namespace urlmanager.Model
{
    ...
    /// </summary>
    [DataContract(Name = "urlmanagerCreateUrlRewriteRequest")]
    public partial class UrlmanagerCreateUrlRewriteRequest : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UrlmanagerCreateUrlRewriteRequest" /> class.
        /// </summary>
        /// <param name="tenantId">Required..</param>
        /// <param name="context">Required..</param>
        /// <param name="requestPath">Required..</param>
        /// <param name="targetPath">Required..</param>
        /// <param name="redirectType">redirectType.</param>
        /// <param name="linkRel">linkRel.</param>
        public UrlmanagerCreateUrlRewriteRequest(string tenantId = default(string), string context = default(string), string requestPath = default(string), string targetPath = default(string), UrlRewriteRedirectType? redirectType = default(UrlRewriteRedirectType?), UrlRewriteLinkRel? linkRel = default(UrlRewriteLinkRel?))
        {
