...
namespace urlmanager.Model
{
    ...
    /// </summary>
    [DataContract(Name = "urlmanagerDeleteUrlRewriteRequest")]
    public partial class UrlmanagerDeleteUrlRewriteRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UrlmanagerDeleteUrlRewriteRequest" /> class.
        /// </summary>
        /// <param name="tenantId">Required..</param>
        /// <param name="id">Required..</param>
        public UrlmanagerDeleteUrlRewriteRequest(string tenantId = default(string), string id = default(string))
        {
