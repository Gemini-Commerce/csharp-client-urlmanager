...
namespace urlmanager.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetUrlRewriteRequestCompoundIdentifier")]
    public partial class GetUrlRewriteRequestCompoundIdentifier : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetUrlRewriteRequestCompoundIdentifier" /> class.
        /// </summary>
        /// <param name="context">context.</param>
        /// <param name="requestPath">requestPath.</param>
        public GetUrlRewriteRequestCompoundIdentifier(string context = default(string), string requestPath = default(string))
        {
