...
namespace urlmanager.Model
{
    ...
    /// </summary>
    [DataContract(Name = "urlmanagerResolveUrlRewriteRequest")]
    public partial class UrlmanagerResolveUrlRewriteRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UrlmanagerResolveUrlRewriteRequest" /> class.
        /// </summary>
        /// <param name="tenantId">Required..</param>
        /// <param name="context">Required..</param>
        /// <param name="requestPath">Required..</param>
        public UrlmanagerResolveUrlRewriteRequest(string tenantId = default(string), string context = default(string), string requestPath = default(string))
        {
